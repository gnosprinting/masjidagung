                                                ...
                                                <div class='input-group {{ ($col["type_data"] == "time")?"bootstrap-timepicker":"" }}'>
                                                    ...
                                                    <input
                                                            ...
                                                            value='<?php
                                                                ...
                                                                echo (CRUDBooster::getTypeFilter($col["field_with"]) == 'between') ? $value[0] : "asu";
                                                            ?>'>
                                                </div>
                                            </div>
                                            <div class='col-sm-6'>
                    ...
                    <form method='post' target="_blank" action='{{ CRUDBooster::mainpath("export-data?t=".time()) }}'>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type='text' name='filename' class='form-control' required value='Report {{ $module_name }} - {{date("d M Y")}} - {{(CRUDBooster::getTypeFilter($col["field_with"]) == 'between') ? $value[0] : ""}}'/>
